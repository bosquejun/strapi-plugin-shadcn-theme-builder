...
export default function ToggleTailwindMode() {
  const id = useId();
  const { toggleDarkMode, isDarkMode } = useThemePresets();
      ...
      <div className="relative inline-grid h-10 w-20 grid-cols-[1fr_1fr] items-center font-medium text-sm">
        <Switch
          ...
          className={cn(
            ...
            'data-[state=unchecked]:!bg-(--strapi-primary200) data-[state=checked]:!bg-(--strapi-primary600)'
          )}
          id={id}
