...
const ChartTooltipContentImpl = React.forwardRef<
  HTMLDivElement,
...
const ChartTooltipContent: (props: any) => JSX.Element | null =
  ChartTooltipContentImpl as unknown as (props: any) => JSX.Element | null;
